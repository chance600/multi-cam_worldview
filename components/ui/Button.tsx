...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "inline-flex items-center justify-center font-medium transition-all duration-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900";
  ...
  const variants = {
    ...
    glass: "bg-white/10 hover:bg-white/20 text-white backdrop-blur-sm border border-white/10"
  };
